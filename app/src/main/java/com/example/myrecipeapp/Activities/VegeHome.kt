...
class VegeHome : AppCompatActivity() {
    ...
    internal lateinit var mRecipeCat: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vege_home)
        ...
        mRecipeCat = "V"
        mRecipeAdopter = RecipeAdopter(this@VegeHome, mRecipes, mGetChild!!, mRecipeCat)
        mSelectedRecipe = FirebaseDatabase.getInstance().reference.child("Recipe").child("Vage").child("V").child(mGetChild!!)
        ...
        mSelectedRecipe!!.addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(dataSnapshot: DataSnapshot, s: String?) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(this@VegeHome, "Sorry some error ", Toast.LENGTH_SHORT).show()
                }
        ...
        mBackBtn.setOnClickListener {
            val intent = Intent(this@VegeHome, MainActivity::class.java)
